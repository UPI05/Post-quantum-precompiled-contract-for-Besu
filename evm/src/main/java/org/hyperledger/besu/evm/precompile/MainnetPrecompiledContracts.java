...
public interface MainnetPrecompiledContracts {
  ...
  static void populateForFrontier(
    ...
    registry.put(Address.ML_DSA44, new MLDSA44PrecompiledContract(gasCalculator));
    registry.put(Address.ML_DSA65, new MLDSA65PrecompiledContract(gasCalculator));
    registry.put(Address.ML_DSA87, new MLDSA87PrecompiledContract(gasCalculator));
  }
