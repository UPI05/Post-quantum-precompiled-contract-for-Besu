...
public class MLDSA87PrecompiledContract extends AbstractPrecompiledContract {
  // Load native library
  static {
    try {
      System.load(
          "/home/d1l1th1um/Desktop/Post-quantum-precompiled-contract-for-Besu/customized/libmldsa87.so");
   ...
   */
  public MLDSA87PrecompiledContract(final GasCalculator gasCalculator) {
    super("MLDSA87", gasCalculator);
  }
