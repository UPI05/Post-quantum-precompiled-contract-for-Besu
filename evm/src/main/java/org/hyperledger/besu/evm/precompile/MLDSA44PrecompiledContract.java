...
public class MLDSA44PrecompiledContract extends AbstractPrecompiledContract {
  ...
  static {
    try {
      System.load(
          "/home/d1l1th1um/Desktop/Post-quantum-precompiled-contract-for-Besu/customized/libmldsa44.so");
   ...
   */
  public MLDSA44PrecompiledContract(final GasCalculator gasCalculator) {
    super("MLDSA44", gasCalculator);
  }
